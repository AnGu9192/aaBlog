...
<div class="container">
    <div class="contactForm">
        <form action="<?php echo BASE_URL; ?>actions/editProfileAction.php" method="post" autocomplate="off">
            ...
            <div class="inputBox">
                <input type="password" name="password" id="password" class="password-container"
            ...
            <div class="inputBox">
                <input type="password" name="repeat_password" id="repeat_password" class="password-container"
                    value="<?= isset($_SESSION["old"]["password"]) ? $_SESSION["old"]["password"] : '' ?>">
                <i class="fa fa-eye" id="repeat-eye"></i>

                <span>Repeat password*</span>
                <p class="error">
                    <?= isset($_SESSION["errors"]["repeat_password"]) ? $_SESSION["errors"]["repeat_password"] : '' ?>
                </p>
